...
`forge.cellular_motion` gives the 45 symmetry-refined structural offspring a
...
and collision step. Destroying the neural organ stops intentional motion.
...
python -m forge.cellular_motion validate `
  outputs/cellular_motion_v1/cellular_motion_manifest.json
...
`outputs/cellular_motion_v1/cellular_motion_contact_sheet.png`. It shows one
