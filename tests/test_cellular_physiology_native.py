...
SOURCE = ROOT / "outputs/cellular_physiology_v1/cellular_physiology_manifest.json"
RUNTIME = ROOT / "game/generated/cellular_physiology/v3"
...
def test_motion_lab_loads_and_applies_connected_physiology() -> None:
    ...
    assert 'physiology_catalog_path = "res://generated/cellular_physiology/v3/catalog.json"' in scene
    for feature in (
