...
RUNTIME = ROOT / "game/generated/cellular_physiology/v4_2"
...
def test_motion_lab_loads_and_applies_connected_physiology() -> None:
    ...
    assert 'physiology_catalog_path = "res://generated/cellular_physiology/v4_2/catalog.json"' in scene
    for feature in (
        ...
        "physiology_network_reachable", "motion_chain_depth",
    ):
