...
SOURCE = ROOT / "outputs/cellular_trauma_v1/cellular_trauma_manifest.json"
RUNTIME = ROOT / "game/generated/cellular_trauma/v1"
SCENE = ROOT / "game/CellularMotionLab.tscn"
SCRIPT = ROOT / "game/scripts/cellular_motion_lab.gd"
REPORT = ROOT / "outputs/cellular_trauma_motion_godot_report.json"
...
def test_motion_lab_loads_clots_scars_magnetism_and_fragment_fates() -> None:
    ...
    assert 'trauma_catalog_path = "res://generated/cellular_trauma/v1/catalog.json"' in scene
...
def test_godot_smoke_proves_reconnection_scar_and_plant_polyp() -> None:
    ...
    assert report["format"] == "nullvector-cellular-motion-godot-smoke-v3" and report["passed"] is True
