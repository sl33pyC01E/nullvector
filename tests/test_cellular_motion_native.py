...
RUNTIME = ROOT / "game/generated/cellular_motion/v6"
...
def test_native_scene_uses_live_organ_drivers_not_sprite_frames() -> None:
    ...
    assert 'motion_catalog_path = "res://generated/cellular_motion/v6/motion_catalog.json"' in scene
...
def test_native_smoke_exhausts_motion_programs_and_actuates_damageable_body() -> None:
    ...
    assert report["format"] == "nullvector-cellular-motion-godot-smoke-v6"
