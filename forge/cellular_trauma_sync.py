...
FORMAT = "nullvector-cellular-trauma-runtime-v4"
CATALOG_FORMAT = "nullvector-cellular-trauma-native-catalog-v4"
DEFAULT_SOURCE = PROJECT_ROOT / "outputs/cellular_trauma_v4/cellular_trauma_manifest.json"
DEFAULT_DESTINATION = PROJECT_ROOT / "game/generated/cellular_trauma/v8"
