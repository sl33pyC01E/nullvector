...
FORMAT = "nullvector-cellular-trauma-runtime-v1"
CATALOG_FORMAT = "nullvector-cellular-trauma-native-catalog-v1"
DEFAULT_SOURCE = PROJECT_ROOT / "outputs/cellular_trauma_v1/cellular_trauma_manifest.json"
DEFAULT_DESTINATION = PROJECT_ROOT / "game/generated/cellular_trauma/v1"
