...
def main() -> int:
    ...
    train = sub.add_parser("train"); train.add_argument("--output", type=Path, required=True); train.add_argument("--steps", type=int, default=4096); train.add_argument("--segment-steps", type=int, default=512); train.add_argument("--batch-size", type=int, default=90); train.add_argument("--max-attempts", type=int, default=3)
