...
FORMAT = "nullvector-connected-cellular-physiology-runtime-v3"
CATALOG_FORMAT = "nullvector-connected-cellular-physiology-native-catalog-v5"
DEFAULT_SOURCE = PROJECT_ROOT / "outputs/cellular_physiology_v2/cellular_physiology_manifest.json"
DEFAULT_DESTINATION = PROJECT_ROOT / "game/generated/cellular_physiology/v5"
...
def project_runtime(source_manifest: Path = DEFAULT_SOURCE) -> dict[str, bytes]:
    ...
    catalog: dict[str, object] = {
        "format": CATALOG_FORMAT, "status": "ready", "bundle_version": 5,
