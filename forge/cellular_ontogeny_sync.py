...
FORMAT = "nullvector-cellular-ontogeny-native-catalog-v1"
DEFAULT_SOURCE = DEFAULT_OUTPUT / "cellular_ontogeny_manifest.json"
DEFAULT_DESTINATION = PROJECT_ROOT / "game/generated/cellular_ontogeny/v1"
...
def project_runtime(source_manifest: Path) -> dict[str, bytes]:
    ...
    registry = _source_registry(); catalog: dict[str, object] = {
        "format": FORMAT, "status": "ready", "bundle_version": 1, "source_manifest_sha256": sha256_file(source_manifest), "source_semantic_sha256": source["semantic_sha256"],
