...
FORMAT = "nullvector-cellular-neuromuscular-native-catalog-v1"
DEFAULT_SOURCE = PROJECT_ROOT / "outputs/cellular_motion_v1/cellular_motion_manifest.json"
DEFAULT_DESTINATION = PROJECT_ROOT / "game/generated/cellular_motion/v1"
