...
FORMAT = "nullvector-cellular-neuromuscular-native-catalog-v6"
DEFAULT_SOURCE = PROJECT_ROOT / "outputs/cellular_motion_v2/cellular_motion_manifest.json"
DEFAULT_DESTINATION = PROJECT_ROOT / "game/generated/cellular_motion/v6"
...
def project_runtime(source_manifest: Path) -> dict[str, bytes]:
    ...
    catalog: dict[str, object] = {
        "format": FORMAT, "status": "ready", "bundle_version": 6,
